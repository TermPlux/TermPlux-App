...
internal class ChineseCaleUtil private constructor(){
    ...
    internal companion object {
        ...
        internal fun getChineseCale(): String {
            ...
            val lunarGanZhi = ChineseCaleUtil().cyclical(year, month, day)
            val lunarAnimal = ChineseCaleUtil().animalsYear(year)
            val lunarString = ChineseCaleUtil().getLunarString(year, month, day)

...
internal class TermPluxService : Service(), Shizuku.OnBinderReceivedListener,
    Shizuku.OnBinderDeadListener, Shizuku.OnRequestPermissionResultListener {

    private lateinit var mService: TermPluxService
    private lateinit var poem: ArrayList<String>

    override fun onCreate() {
        super.onCreate()
        mService = this@TermPluxService
